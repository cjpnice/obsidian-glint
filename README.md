...
- Create a GitHub release whose tag exactly matches the `version` in `manifest.json`, for example `0.2.2`.
...
If GitHub Actions is enabled, pushing a tag like `0.2.2` automatically builds the plugin and uploads the required release assets.
